...
# Banana.dev EverythingLM-13b-V2-16K-GPTQ starter template

This is a EverythingLM-13b-V2-16K-GPTQ starter template from [Banana.dev](https://www.banana.dev) that allows on-demand serverless GPU inference.
...
1. [Fork this](https://github.com/yachty66/demo-everythinglm-13b-v2-16k-gptq/fork) repository to your own Github account.
